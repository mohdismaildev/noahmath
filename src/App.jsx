                ...
                {ALL_TABLES.map((n) => {
                  ...
                  return (
                    <button
                      ...
                      className={
                        `rounded-xl px-0 py-2 text-center text-sm font-bold shadow-sm focus:outline-none focus:ring-2 ` +
                        (active ? 'bg-green-600 text-white focus:ring-green-300' : 'bg-white text-slate-700 border border-slate-300 hover:-translate-y-0.5 hover:shadow focus:ring-green-300 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-700')
                      }
                    >
                      ×{n}
                    </button>
